<template>
  <div class="container">
    ...
    <div class="head-social">
      ...
      <!-- Github -->
      <a href="https://github.com/dead-summer" target="_blank" class="head-social-btn">
    ...
    <div class="about-me">
      <div class="card-content grid-row-3-2">
        ...
        <AboutMeName>
          <template #name>
            <p>Summer Reverie</p>
            <p class="about-me-card-text-big">Every reverie is an endless summer.</p>
            <p>每一次遐想，都是一个无尽的夏日。</p>
          </template>
        </AboutMeName>
        <!-- 文本卡片 -->
        <AboutMeText>
          <template #motto>
            <slot name="motto">
              <p class="about-me-card-title-normal">OATH</p>
              <p class="about-me-card-text-big">My watch begins, </p>
              <p class="about-me-card-text-big about-me-card-text-color">in the endless summer.</p>
            </slot>
          </template>
        </AboutMeText>
      </div>
      <div class="card-content grid-row-3-2">
        <!-- 技能卡片 -->
        <AboutMeSkill :technology="MyTechnology" :tools="MyTools"/>
        <AboutMeLife/>
      </div>
